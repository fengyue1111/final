<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="owo.aspx.cs" Inherits="final.owo" %>
...
<body>
     <form id="form1" runat="server">
       <div style="font-family: 標楷體; font-size: large; font-style: normal; text-transform: uppercase;">
            ...
            <br />
            <asp:Button ID="Button1" runat="server" Text="送出"  PostBackUrl="~/page1.aspx" Height="21px" Width="47px" Font-Names="標楷體" Font-Size="Medium"/>
